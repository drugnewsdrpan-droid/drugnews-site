...
![圖 1｜Claude 開始動手做實驗：AI 從螢幕走向實驗台](images/cover.png)
...
![圖 2｜MHS 共通層：研究者、AI 代理與多品牌設備如何連起來](images/figure-02.png)
...
![圖 3｜兩個實驗室案例：蛋白質測定與高通量設備交接](images/figure-03.png)
...
![圖 4｜AI 實驗室價值鏈：受益者、壓力與四道風險閘門](images/figure-04.png)
