...
![Dcard 原圖：亞馬遜（Amazon） 參戰 AI 製藥，挑戰輝達（Nvidia）（圖 1）](images/dcard-01.webp)
...
![Dcard 原圖：亞馬遜（Amazon） 參戰 AI 製藥，挑戰輝達（Nvidia）（圖 2）](images/dcard-02.webp)
...
![Dcard 原圖：亞馬遜（Amazon） 參戰 AI 製藥，挑戰輝達（Nvidia）（圖 3）](images/dcard-03.png)
