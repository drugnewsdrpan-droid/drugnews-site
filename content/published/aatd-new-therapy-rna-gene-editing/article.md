...
![AATD 治療正在從傳統補蛋白，走向長效重組蛋白、RNA 編輯與基因編輯並行的新競賽。](images/dcard-01.webp)
...
![Sanofi、Wave 與 Beam 分別代表不同技術路徑，也對應不同的風險、療效與商業化想像。](images/dcard-02.webp)
...
![罕見遺傳病的下一階段，不只是補足缺失蛋白，而是能否安全、持久地修正疾病根源。](images/dcard-03.png)
