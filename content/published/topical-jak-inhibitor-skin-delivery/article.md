...
![外用 JAK 抑制劑的勝負不只在靶點，而在皮膚穿透、局部濃度與全身暴露的平衡。](images/dcard-01.webp)
...
![Ruxolitinib、delgocitinib 與前藥策略代表外用 JAK 抑制劑的不同開發路徑。](images/dcard-02.png)
...
![台灣公司若切入外用 JAK 賽道，關鍵是特定適應症定位、臨床驗證與國際授權故事。](images/dcard-03.png)
