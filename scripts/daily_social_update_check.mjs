...
async function main() {
  ...
  if (captureFacebook) {
    const scriptArgs = facebookRegularCurrent
      ? ["scripts/scrape_facebook_regular_chrome.mjs", "current", fbInput]
      : [
