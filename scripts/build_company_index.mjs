...
<header class="site-header">
  <div class="container nav">
    ...
    <nav class="nav-links" aria-label="Main navigation">
      ...
      <a href="companies.html" aria-current="page">公司索引</a>
      <a href="guides/">指南</a>
...
<footer class="site-footer"><div class="container footer-grid"><div><strong>Drugnews｜藥時事</strong><p>生技醫藥商業分析文章媒體。</p></div><div><a href="articles/">文章</a><a href="companies.html">公司索引</a><a href="subscribe.html">付費專欄</a><a href="services.html">公司合作</a></div></div></footer>
</body>
</html>`;
}
...
async function updateSitemap() {
  ...
  if (!sitemap) return;
  const entry = `  <url><loc>${BASE_URL}/companies.html</loc><priority>0.75</priority></url>`;
