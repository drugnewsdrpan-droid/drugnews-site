...
async function main() {
  ...
  const checks = [
    ...
    check("sitemap_ai_index", sitemap.includes(`${BASE_URL}/ai-index.json`) && sitemap.includes(`${BASE_URL}/llms.txt`) && sitemap.includes(`${BASE_URL}/knowledge-graph.json`), "sitemap includes AI-readable files", "warning"),
